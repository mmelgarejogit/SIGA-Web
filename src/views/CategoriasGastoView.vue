...
<template>
  <div class="min-h-screen" style="background-color: var(--color-background)">
    ...
    <BaseModal :show="showCreate" title="Nueva Categoría" size="sm" @close="showCreate = false">
      ...
      <template #footer>
        <BaseButton variant="secondary" size="default" @click="showCreate = false">Cancelar</BaseButton>
    ...
    <BaseModal :show="showEdit" title="Editar Categoría" size="sm" @close="showEdit = false">
      ...
      <template #footer>
        <BaseButton variant="secondary" size="default" @click="showEdit = false">Cancelar</BaseButton>
