  ...
  <div class="min-h-screen" style="background-color: var(--color-background)">
    ...
    <BaseModal :show="showEditModal" title="Editar Cliente" size="lg" @close="showEditModal = false">
      <form @submit.prevent="submitEdit" class="space-y-5">
        ...
        <div v-if="editErrors.contact" class="flex items-center gap-2 rounded-2xl px-4 py-3 text-sm font-medium" style="background-color: var(--color-warning-container); color: var(--color-on-warning-container)">
    ...
    <BaseModal :show="showEstadoModal" size="sm" @close="showEstadoModal = false">
      <div class="text-center">
        <div
          ...
          :style="estadoActivar ? 'background-color: var(--color-success-container)' : 'background-color: var(--color-error-container)'"
        >
          <span class="material-symbols-outlined" style="font-size: 28px" :style="estadoActivar ? 'color: var(--color-success)' : 'color: var(--color-error)'">
