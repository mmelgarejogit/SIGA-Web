...
watch([search, items, filtroFactura], () => { currentPage.value = 1 })
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <input :value="factForm.numeroFactura" @input="onNroFacturaInput" type="text" placeholder="001-001-0000001"
              ...
              class="w-full px-4 h-12 rounded-md text-sm outline-none appearance-none shadow-none transition-all font-mono" :style="inputStyle()" />
          </div>
