...
export const SYSTEM_PERMISSIONS = [
  ...
  { id: "desactivar_cliente",     label: "Desactivar cliente" },
  ...
  { id: "aprobar_cierres_caja",   label: "Aprobar cierres de caja" },
  ...
  { id: "gestionar_notificaciones", label: "Gestionar notificaciones" },
  ...
  { id: "ver_sucursales",         label: "Ver sucursales" },
  { id: "gestionar_sucursales",   label: "Gestionar sucursales" },
  { id: "ver_todas_sucursales",   label: "Ver todas las sucursales" },
  { id: "transferir_stock",       label: "Transferir stock entre sucursales" },
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    module: "Clientes",
    icon: "person",
    description: "Clientes de venta y facturación",
    permissions: [
      { id: "ver_clientes",       label: "Ver clientes" },
      { id: "crear_cliente",      label: "Crear cliente" },
      { id: "editar_cliente",     label: "Editar cliente" },
  ...
  },
  {
    module: "Sucursales",
    icon: "store",
    description: "Sucursales y transferencias de stock entre ellas",
    permissions: [
      { id: "ver_sucursales",       label: "Ver sucursales" },
      { id: "gestionar_sucursales", label: "Gestionar sucursales" },
      { id: "ver_todas_sucursales", label: "Ver todas las sucursales" },
